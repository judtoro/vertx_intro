...
import com.globant.vtxintro.WhiskyStoreVerticleEB;
...
public class MyFirstVerticleTest {
  ...
  public void setUp(TestContext context) {
    ...
    try {
      ...
      vertx.deployVerticle(WhiskyStoreVerticleEB.class.getName(), options);
      vertx.deployVerticle(FeatureVerticle.class.getName(), options);
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
  ...
  public void checkThatWeCanAdd(TestContext context) {
    ...
    vertx.createHttpClient().post(port, "localhost", "/api/whiskies")
        .putHeader("content-type", "application/json").putHeader("content-length", length)
        .handler(response -> {
